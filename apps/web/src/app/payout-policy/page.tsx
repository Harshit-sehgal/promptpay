        ...
        <div className="prose prose-surface max-w-none">
          <section className="mb-10">
            ...
            <p className="text-surface-600 leading-relaxed mb-4">
              ...
              Earnings become available for payout after passing a hold period (3 days for new accounts,
              longer for higher trust levels). Held earnings are released after fraud investigation completes.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-surface-600 leading-relaxed mb-4">
              Minimum payout threshold is $50 in confirmed earnings. Payouts below the threshold
              remain in the user balance and aggregate with future earnings.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-surface-600 leading-relaxed mb-4">
              ...
              fraud and payment reserve. A launch incentive of 80/10/10 is in effect during the
              early period — see terms for current cutoffs. All splits are calculated automatically
              per qualified impression or click.
            </p>
          </section>
