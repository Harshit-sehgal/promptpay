    ...
    <div className="min-h-screen bg-ink-900 px-6 py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-ink-300 text-sm leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">3. Developer obligations</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">4. Advertiser obligations</h2>
          <ul className="list-disc pl-6 space-y-1">
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">5. Fraud policy</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">6. Revenue sharing</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">7. Payout terms</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">8. Disclaimer</h2>
