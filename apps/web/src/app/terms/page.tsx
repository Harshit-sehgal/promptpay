        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mb-10 rounded-xl border border-amber-200 bg-amber-50 p-5 text-amber-950">
            ...
            <p className="mt-1 text-sm leading-relaxed">
              ...
              compensation and payout sections below describe the planned launch policy, not an
              active entitlement.
            </p>
          </div>
          <div className="text-surface-600 text-sm leading-relaxed space-y-6">
            ...
            <p>
              ...
              Rewards and advertiser billing are disabled during the beta. If rewards are approved
              and enabled, developers may receive compensation for verified eligible activity under
              a separately published schedule, and advertisers may reach a high-intent developer
              audience.
            </p>
            ...
            <p>
              Fraudulent activity will result in earnings reversal, account restriction, and
              potential legal action. We use automated detection and manual review to protect
              platform integrity.
            </p>
            ...
            <p>
              Participant rewards are disabled during the private beta. If rewards launch, the rate
              is 60% of the qualifying bid for a verified impression, with the remaining 40%
              retained by Ateva. That amount is calculated and owed by Ateva; it is not a claim on
              any individual advertiser payment. An advertiser transaction settles in full to Ateva,
              and participant compensation is a separate Ateva obligation discharged through a
              different provider. See the{' '}
            ...
            <p>
              ...
              confirmed eligible rewards must reach the published minimum threshold, new accounts
              are subject to a 30-day hold period, and processing times vary by the approved payout
