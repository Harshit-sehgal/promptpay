      ...
      <main id="main-content" tabIndex={-1} className="px-6 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="text-surface-600 text-sm leading-relaxed space-y-6">
            <p
              className="public-manifesto-quote text-lg text-surface-800 italic"
              style={{
                fontSize: '18px',
                borderLeft: '3px solid var(--ateva-blush-ink)',
                paddingLeft: '16px',
              }}
            >
              “Developer attention should be respected. Privacy is absolute. Any reward system must
              be transparent, verifiable, and separate from customer payment custody.”
            </p>
