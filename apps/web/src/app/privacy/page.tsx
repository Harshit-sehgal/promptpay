...
export default function PrivacyPage() {
  ...
  return (
    <div className="public-page min-h-screen bg-surface-50">
      <SiteHeader />
      <main id="main-content" tabIndex={-1} className="px-6 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <section className="space-y-4 text-surface-600 text-sm leading-relaxed">
            <p>
              Ateva is a privacy-first private beta for AI coding assistant wait-state verification.
              Rewards and advertiser billing are disabled while independent attestation is
              completed. We never read your source code or prompts. We collect only the data needed
            ...
            <p>
              ...
              may delete your account, which anonymizes your personal information. For details see
              our{' '}
              <Link
                href="/legal/gdpr-dpa"
