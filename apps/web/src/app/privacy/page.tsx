      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <section className="space-y-4 text-surface-600 text-sm leading-relaxed">
          <p>
            ...
            Rewards and advertiser billing are disabled while independent attestation is completed.
            We never read your source code or prompts. We collect only the data needed to operate
            the service: your account email, payout details you provide, ad interaction events
            (hashed), and consent records.
          </p>
          <p>
