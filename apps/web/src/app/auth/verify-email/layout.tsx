...
/**
 * Metadata carrier for `auth/verify-email`.
 *
...
export const metadata: Metadata = {
  title: 'Verify your email — WaitLayer',
  description: 'Confirm your email address to finish setting up your WaitLayer account.',
