    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-50 px-6">
      <div className="w-full max-w-sm text-center">
        <div className="bg-white border border-surface-200/80 rounded-2xl p-8 shadow-sm shadow-surface-200/40">
          <h2 className="text-xl font-bold text-surface-900 mb-2 tracking-tight">Something went wrong</h2>
          <p className="text-surface-500 text-[14px] mb-6">An unexpected error occurred while loading the email verification page.</p>
          <button
            onClick={reset}
