...
export const metadata: Metadata = {
  ...
  description:
    'WaitLayer advertiser policy — eligibility, ad content guidelines, billing, fraud prevention, and account suspension policies.',
};
        ...
        <div className="prose prose-surface max-w-none">
          <section className="mb-10">
            ...
            <p className="text-surface-600 leading-relaxed mb-4">
              Advertisers must provide accurate business information and comply with all applicable
              laws and regulations. We reserve the right to reject or remove any advertiser account
              that violates these policies.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-surface-600 leading-relaxed mb-4">
              All ad creatives must be truthful, non-deceptive, and clearly labeled as sponsored
              content. Prohibited categories include but are not limited to: malware, phishing,
              illegal substances, adult content, and gambling. All creatives are subject to review
              before activation.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-surface-600 leading-relaxed mb-4">
              ...
              (self-clicking, bot traffic, duplicate clicks) are not billed. We reserve the right to
              adjust billing based on fraud investigation outcomes.
            </p>
          </section>
