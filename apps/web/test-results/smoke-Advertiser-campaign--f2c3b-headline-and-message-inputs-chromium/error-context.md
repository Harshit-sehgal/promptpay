...
- Name: smoke.spec.ts >> Advertiser campaign creation (authenticated) >> shows ad creative section with headline and message inputs
- Location: e2e/smoke.spec.ts:183:7
...
Call log:
  ...
  - waiting for getByLabel('Headline')
