...
| `docs/ops/waitlayer-release-backlog.md`                 | provider, credentials, branch protection, CI, legal, and infra operator items                     |
...
| `apps/web/src/app/contact/page.tsx`                     | beta support contacts and explicitly non-guaranteed availability                                  |
| `apps/web/src/app/terms/page.tsx`                       | beta wording and operator-dependent rewards/hold language                                         |
| `apps/web/src/app/payout-policy/page.tsx`               | operator-dependent payout policy and supported-currency surface                                   |
| `docs/legal/gdpr-dpa.md`                                | private-beta draft with entity and privacy contact pending confirmation                           |
