...
- **Ledger**: Three-ledger accounting (earnings, advertiser, platform) with a planned 60/30/10 split; real settlement remains disabled in beta
...
- **Referrals**: Code-based referral foundation; rewards are not active in beta
