...
CREATE TABLE "sandbox_credit_accounts" (
  ...
  CONSTRAINT "sandbox_credit_accounts_id_environment_id_key" UNIQUE ("id", "environment_id"),
  CONSTRAINT "sandbox_credit_accounts_id_user_id_environment_id_key" UNIQUE ("id", "user_id", "environment_id"),
  ...
  CONSTRAINT "sandbox_credit_accounts_user_id_fkey"
...
CREATE TABLE "sandbox_credit_entries" (
  ...
  CONSTRAINT "sandbox_credit_entries_account_id_environment_id_fkey"
    FOREIGN KEY ("account_id", "environment_id")
    REFERENCES "sandbox_credit_accounts"("id", "environment_id") ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE UNIQUE INDEX "sandbox_credit_entries_account_id_idempotency_key_key"
